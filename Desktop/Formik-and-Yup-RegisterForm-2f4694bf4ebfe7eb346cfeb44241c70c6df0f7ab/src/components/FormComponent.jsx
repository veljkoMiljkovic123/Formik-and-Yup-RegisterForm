...
import { logeddUserAction } from '../store/userSlice';
...
function FormComponent() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            .then(res=>{
                ...
                dispatch(logeddUserAction({...values,image:res}))
                navigate('/')
            })
  ...
  return <form onSubmit={formik.handleSubmit} className='bg-slate-300 p-[20px] rounded-lg mt-5 flex flex-col gap-3 w-full md:w-[500px]'>
    {/* firstName */}
